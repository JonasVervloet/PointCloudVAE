...
def auto_encode_clouds(network, data_generator, save_manager, name=""):
    ...
    for batch in val_loader:
        in_points_list, in_batch_list, out_points_list, out_batch_list, lat_features = network(batch)
        ...
        save_manager.save_mesh_plot(plot, "auto_encode_clouds_{}_i".format(name))